...
const DrumRudimentsApp = () => {
  ...
  const translations = {
    ...
    pt: {
      ...
      randomAccent: 'Ativar Acento em Sequência Aleatória',
  ...
  const startPlayback = useCallback(() => {
    ...
    const playNextSubdivision = () => {
      ...
      if (subdivisionIndex < currentNote.subdivisions) {
        ...
        const isAccented = currentNote.accents && currentNote.accents.includes(subdivisionIndex);

        playNoteSound(currentHand, isRest, subdivisionIndex, isAccented);
                    ...
                    >
                      ...
                      {note.type === 'sixteenth' && (
                        <div className="relative">
                          ...
                          <div className="absolute top-12 left-3 right-3 h-0.5 bg-gray-800 dark:bg-gray-200"></div>
                        </div>
                      )}
